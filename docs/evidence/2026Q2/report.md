...
- Decision (approve / reject, with notes): approve — landing headline manager count now derived from data (was hardcoded "Twenty"); no data changes vs prior signed release
